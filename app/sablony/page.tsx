...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Šablony pro 3D tisk zdarma – domácnost", description: "Nejlepší free STL soubory pro domácnost a dílnu.", url: "https://www.domovniguru.cz/sablony", siteName: "DomovniGuru", locale: "cs_CZ", type: "website", images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "DomovniGuru" }] },
};
