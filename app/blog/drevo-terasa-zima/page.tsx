...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Jak ošetřit dřevěnou terasu 2026", description: "Broušení, čištění, olej nebo lazura – kompletní postup jarního ošetření terasy.", url: "https://www.domovniguru.cz/blog/drevo-terasa-zima", siteName: "DomovniGuru", locale: "cs_CZ", type: "article", publishedTime: "2026-04-14T08:00:00Z", modifiedTime: "2026-04-14T08:00:00Z", authors: ["DomovniGuru"], images: [{ url: "/api/og?title=Jak%20o%C5%A1et%C5%99it%20d%C5%99ev%C4%9Bnou%20terasu%20%E2%80%93%20brou%C5%A1en%C3%AD%2C%20olej%20a%20lazura%202026&cat=blog", width: 1200, height: 630, alt: "Jak ošetřit dřevěnou terasu – broušení, olej a lazura 2026" }] },
