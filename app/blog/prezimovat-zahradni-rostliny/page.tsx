...
export const metadata: Metadata = {
  title: "Jak přezimovat zahradní rostliny – co, kdy a jak 2026",
        ...
        <div className="article-layout">
          <article className="article-body">
            ...
            <header className="article-header">
              ...
              <ShareButtons url="https://www.domovniguru.cz/blog/prezimovat-zahradni-rostliny" title="Jak přezimovat zahradní rostliny – co, kdy a jak 2026" />
            </header>
