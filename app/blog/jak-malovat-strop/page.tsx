      ...
      <article className="article-body" style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <section style={{ lineHeight: 1.8, fontSize: "18px" }}>
          ...
          <div style={{ background: "#fdfcf0", padding: "25px", borderRadius: "12px", margin: "30px 0", border: "1px solid #e0dcb8" }}>
            ...
            Klíčem k úspěchu je rychlost. Nikdy nenechte okraj barvy zaschnout, než k němu přimalujete další pruh. Pracujte v pásech o šířce cca 1 metr a postupujte systematicky od jednoho konce ke druhému.
          </div>

          <h2>2. Výběr správného nářadí</h2>
          <p>Váleček na stěny nemusí být vhodný na strop. Na strop potřebujete takový, který "neplive" a drží barvu v sobě.</p>
