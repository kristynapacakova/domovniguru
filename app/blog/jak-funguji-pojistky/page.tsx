...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Jak fungují pojistky a jističe 2026", description: "Starý rozvaděč s pojistkami – jak fungují, jak je vyměnit a kdy volat elektrikáře.", url: "https://www.domovniguru.cz/blog/jak-funguji-pojistky", siteName: "DomovniGuru", locale: "cs_CZ", type: "article", publishedTime: "2026-04-15T08:00:00Z", modifiedTime: "2026-04-15T08:00:00Z", authors: ["DomovniGuru"], images: [{ url: "/api/og?title=Jak%20funguj%C3%AD%20pojistky%20a%20jisti%C4%8De%20%E2%80%93%20v%C3%BDm%C4%9Bna%20a%20bezpe%C4%8Dnost%202026&cat=blog", width: 1200, height: 630, alt: "Jak fungují pojistky a jističe – výměna a bezpečnost 2026" }] },
