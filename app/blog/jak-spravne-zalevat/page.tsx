...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Jak správně zalévat zahradu 2026", description: "Ráno nebo večer? Kapková závlaha vs. postřikovač. Jak nezalít příliš ani málo.", url: "https://www.domovniguru.cz/blog/jak-spravne-zalevat", siteName: "DomovniGuru", locale: "cs_CZ", type: "article", publishedTime: "2026-04-14T08:00:00Z", modifiedTime: "2026-04-14T08:00:00Z", authors: ["DomovniGuru"], images: [{ url: "/api/og?title=Jak%20spr%C3%A1vn%C4%9B%20zal%C3%A9vat%20zahradu%20%E2%80%93%20r%C3%A1no%20nebo%20ve%C4%8Der%2C%20kolik%20vody%202026&cat=blog", width: 1200, height: 630, alt: "Jak správně zalévat zahradu – ráno nebo večer, kolik vody 2026" }] },
