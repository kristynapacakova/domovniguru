    ...
    <div className="wrap" style={{ padding: "40px 0" }}>
      <article className="article-body" style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <section style={{ lineHeight: 1.8, fontSize: "18px" }}>
          ...
          <p>Pokud plánujete malovat i stěny, strop musí jít jako první. Barva ze stropu bude nevyhnutelně stříkat dolů. Pokud byste měli stěny už hotové, drobné kapičky bílé barvy (tzv. mlha) by vám je znehodnotily a museli byste je malovat znovu.</p>
          ...
          <div style={{ background: "#fdfcf0", padding: "25px", borderRadius: "12px", margin: "30px 0", border: "1px solid #e0dcb8" }}>
            ...
            Klíčem k úspěchu je rychlost a plynulost. Nikdy nenechte okraj barvy zaschnout, než k němu přimalujete další pruh. Pracujte v ucelených pásech o šířce cca 1 metr a postupujte systematicky od jednoho konce místnosti ke druhému.
          </div>

          <h2>2. Výběr správného nářadí</h2>
          <p>Váleček na stěny nemusí být vhodný na strop. Na strop potřebujete takový, který "neplive", dobře saje a barvu pouští rovnoměrně.</p>
          ...
          <div style={{ margin: "40px 0", background: "#f9f9f7", borderRadius: "12px", padding: "30px", textAlign: "center", border: "1px solid #eee", display: "flex", flexDirection: "column", alignItems: "center" }}>
            <svg width="160" height="120" viewBox="0 0 160 120" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ maxWidth: "100%", height: "auto" }}>
              ...
              {/* Šipky směru */}
              <path d="M 110 40 L 30 40" stroke="#4b5563" strokeWidth="3" strokeLinecap="round" marker-end="url(#arrowhead)"/>
              <path d="M 110 60 L 30 60" stroke="#4b5563" strokeWidth="3" strokeLinecap="round" marker-end="url(#arrowhead)"/>
              <path d="M 110 80 L 30 80" stroke="#4b5563" strokeWidth="3" strokeLinecap="round" marker-end="url(#arrowhead)"/>
              {/* Definice šipky */}
              <defs>
            ...
            <p style={{ fontSize: "13px", color: "#888", marginTop: "15px", maxWidth: "400px" }}>Vždy postupujte v pásech rovnoběžně se směrem dopadajícího světla (od okna do místnosti). Poslední tahy válečkem by měly směřovat k oknu.</p>
          </div>

          <h2>3. Postup, který zajistí výsledek</h2>
          <ol>
            <li><strong>Penetrace:</strong> Nepodceňujte ji. Strop saje víc než stěny. Penetrace zpevní podklad a zajistí, že barva bude schnout pomaleji a rovnoměrněji.</li>
            <li><strong>Osvětlení:</strong> Malujte ideálně při denním světle. Umělé osvětlení často schová drobné nedokonalosti, které uvidíte až druhý den ráno.</li>
            <li><strong>Bezpečnost:</strong> Používejte teleskopickou tyč, abyste nemuseli stát na žebříku a neustále ho posouvat. Plynulý pohyb po celé délce stropu je klíčem k úspěchu.</li>
          </ol>
        </section>
