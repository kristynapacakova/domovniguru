...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Jak malovat zeď – kompletní průvodce 2026",
    description: "Příprava podkladu, penetrace, výběr barvy, technika. Průvodce krok za krokem.",
  },
};
  ...
  "@graph": [
    {
      ...
      "inLanguage": "cs",
      "keywords": ["jak malovat zeď", "malování zdi postup", "příprava zdi před malováním", "penetrace před malováním", "jak vybrat barvu na zeď"],
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.domovniguru.cz/blog/jak-malovat-zed#breadcrumb",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 4, "name": "Jak malovat zeď", "item": "https://www.domovniguru.cz/blog/jak-malovat-zed" },
      ],
    },
    {
      "@type": "FAQPage",
      "@id": "https://www.domovniguru.cz/blog/jak-malovat-zed#faq",
      "mainEntity": [
        { "@type": "Question", "name": "Kolik vrstev barvy na zeď potřebuji?", "acceptedAnswer": { "@type": "Answer", "text": "Standardně stačí 2 vrstvy. Na tmavé podklady nebo velmi sytou barvu doporučujeme 3 vrstvy. Každou vrstvu nechte zaschnout alespoň 2–4 hodiny." } },
        { "@type": "Question", "name": "Musím dávat penetraci před malováním?", "acceptedAnswer": { "@type": "Answer", "text": "Penetrace je nutná na savé nebo nové omítky, sádrokarton a po strhávání tapet. Na malovanou zeď v dobrém stavu ji přeskočit lze, ale zlepší přilnavost barvy." } },
        ...
        <div className="article-layout">
          <article className="article-body">
            ...
            <section id="co-budete-potrebovat">
              ...
              <p>Správné nástroje ušetří hodiny práce a zabrání většině chyb. Před začátkem si nachystej:</p>
              <ul>
                <li><strong>Váleček</strong> – délka 18 cm, vlas 10–12 mm na hladké povrchy, 15–18 mm na hrubší omítku</li>
            ...
            <section id="penetrace">
              ...
              <p>Penetrace zlepšuje přilnavost barvy, sjednocuje savost podkladu a zabraňuje „vsakování" barvy do zdi. Výsledek je rovnoměrnější a barva vydrží déle.</p>
            ...
            <section id="vyber-barvy">
              ...
              <p>Obě jsou na vodní bázi, ale liší se:</p>
              <div className="article-table-wrap">
                <table className="article-table">
                  <thead><tr><th>Vlastnost</th><th>Latexová</th><th>Akrylátová</th></tr></thead>
                  <tbody>
              ...
              <p>Do koupelny, kuchyně nebo sklepa vždy vybírej barvu označenou jako „do vlhkých prostor" nebo s označením odolnosti vůči plísni. Běžná barva v koupelně skončí plísní do pár měsíců.</p>
              <div className="article-cta-box">
                <div className="article-cta-icon">🪣</div>
                <div>
                  <div className="article-cta-title">Nevíš, kolik barvy koupit?</div>
                  <p className="article-cta-desc">Zadej plochu místnosti a naše kalkulačka ti řekne přesný počet litrů i balení – pro jednu i dvě vrstvy.</p>
            ...
            <section id="technika-malovani">
              ...
              <p>Přelep malířskou páskou lišty, zárubně, vypínače a zásuvky. Podlahu zakryj fólií nebo starými novinami. Čas strávený zakrýváním ušetří hodiny čištění.</p>
              <h3>2. Začni od rohů a okrajů</h3>
              <p>Štětcem nanes barvu do všech rohů, podél stropu, kolem lišt a okolo vypínačů – asi 5–8 cm od okraje. Tato fáze se nazývá „odřezávání" a je klíčová pro čistý výsledek.</p>
              <h3>3. Váleček: pohyb W nebo M</h3>
              <p>Váleček neposouvej jen nahoru a dolů – maluj pohybem ve tvaru písmene <strong>W</strong> nebo <strong>M</strong> a pak rovnými tahy zarovnej. Tento postup zabrání pruhům a zajistí rovnoměrné pokrytí.</p>
              <h3>4. Pořadí stěn</h3>
              <p>Ideálně maluj v tomto pořadí: strop → stěny shora dolů. Začni od okna a postupuj do místnosti – přirozené světlo ti ukáže přesně, kde jsou mezery.</p>
              <h3>5. Druhá vrstva</h3>
              <p>Počkej, až první vrstva úplně zaschne – minimálně 2–4 hodiny, ideálně přes noc. Druhá vrstva se nanáší kolmo na první, což pomáhá eliminovat pruhy a zajistí rovnoměrné krytí.</p>
              <div className="article-tip"><strong>💡 Tip:</strong> Mezi vrstvami barvy nezapomeň válečkem nebo štětcem projít kouty a okraje znovu – tam barva schne nejpomaleji a je nejtenčí.</div>
            </section>

            <section id="typicke-chyby">
              <h2>Typické chyby a jak se jim vyhnout</h2>
              <h3>Pruhy a nerovnoměrná barva</h3>
              <p>Příčina: špatný váleček, příliš suchý váleček nebo malování suché plochy vedle mokré. Řešení: pracuj mokré do mokrého, váleček pravidelně přenáč a udržuj rovnoměrný tlak.</p>
              <h3>Barva se loupe</h3>
              <p>Příčina: špatně připravený podklad, mastný povrch nebo malování na vlhkou zeď. Řešení: vždy nejdřív odmaštit a nechat zcela vyschnout.</p>
              <h3>Přesáknutí barvy pod páskou</h3>
              <p>Příčina: páska nebyla dobře přitlačená nebo byla použita na prašném povrchu. Řešení: pásku přilep prstem po celé délce těsně před malováním a sundej ji ještě za mokra pod úhlem 45°.</p>
              <h3>Viditelné spoje tahů</h3>
              <p>Příčina: příliš dlouhé tahy nebo překrývání zaschlé barvy. Řešení: maluj menší plochy a vždy navazuj na mokrou hranu.</p>
            </section>
            ...
            <section id="kalkukacka">
              ...
              <div className="article-cta-box">
                ...
                <div>
                  ...
                  <p className="article-cta-desc">Nechtěj počítat ručně. Zadej rozměry a kalkulačka ti řekne přesné množství i pro různé vydatnosti barev.</p>
                  <Link href="/kalkulacky/kolik-barvy" className="btn btn-black">Spustit kalkulačku →</Link>
                </div>
              </div>
            </section>
            ...
            <section id="faq">
              ...
              <div className="faq-list">
                {[
                  { q: "Kolik vrstev barvy na zeď potřebuji?", a: "Standardně stačí 2 vrstvy. Na tmavé podklady nebo velmi sytou barvu doporučujeme 3 vrstvy. Každou vrstvu nechte zaschnout alespoň 2–4 hodiny." },
                  { q: "Musím dávat penetraci před malováním?", a: "Penetrace je nutná na savé nebo nové omítky, sádrokarton a po strhávání tapet. Na malovanou zeď v dobrém stavu ji přeskočit lze, ale zlepší přilnavost barvy." },
