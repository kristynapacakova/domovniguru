...
export const metadata: Metadata = {
  ...
  description: "Jak správně natřít venkovní dřevo – terasu, plot nebo zahradní nábytek. Lazura, olej nebo lak? Příprava povrchu, výběr přípravku a postup pro dlouhotrvající ochranu.",
