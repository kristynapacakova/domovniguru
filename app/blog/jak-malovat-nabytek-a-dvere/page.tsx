        ...
        <div className="article-layout">
          <article className="article-body">
            ...
            <section id="vyber-barvy">
              ...
              <p>Akrylátové barvy na vodní bázi jsou univerzální volbou pro nábytek i dveře. Po zaschnutí vytvoří odolný, omyvatelný povrch, jsou téměř bez zápachu a dají se ředit vodou. Existují v matném, saténovém i lesklém provedení – pro kuchyně a koupelny doporučujeme alespoň saténový lesk, který lépe odolává otěru a dá se utřít na vlhko. Na extrémně zatěžované dřevo, jako jsou schodové stupně, ale potřebuješ ještě odolnější nátěr – jaký, popisuje článek <Link href="/blog/jak-malovat-drevene-schody" style={{ color: "#2a6496", textDecoration: "underline" }}>jaká barva na dřevěné schody</Link>.</p>
