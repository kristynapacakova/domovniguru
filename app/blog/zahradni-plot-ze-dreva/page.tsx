...
const jsonLd = {
  ...
  {
    "@type": "BreadcrumbList",
    "@id": "https://www.domovniguru.cz/blog/zahradni-plot-ze-dreva#breadcrumb",
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": "Jak postavit dřevěný zahradní plot – postup krok za krokem 2026", "item": "https://www.domovniguru.cz/blog/zahradni-plot-ze-dreva" }
    ]
  }
  ]
};
      ...
      <div className="wrap">
        <div className="article-layout">
          ...
          <aside className="article-sidebar">
            ...
            <div className="sidebar-widget">
              <AdBanner
                href="https://ehub.cz/system/scripts/click.php?a_aid=31989715&a_bid=06c0ada8"
                src="https://doc.ehub.cz/b/9de84fcb/06c0ada8.jpg"
                alt="Aku-shop.cz – akumulátorové nářadí"
                width={970}
                height={250}
              />
            </div>
