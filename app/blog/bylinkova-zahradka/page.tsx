...
export const metadata: Metadata = {
  ...
  description: "Jak založit bylinkovou zahrádku na parapetu, balkonu nebo v zahradě. Které bylinky jsou nejjednodušší, jak je sázet, zalévat a sklízet. Průvodce pro začátečníky.",
