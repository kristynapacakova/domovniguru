...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Jak postavit vyvýšený záhon 2026", description: "Dřevěný nebo betonový vyvýšený záhon – rozměry, výplň a výsev krok za krokem.", url: "https://www.domovniguru.cz/blog/vyvyseny-zahon-postup", siteName: "DomovniGuru", locale: "cs_CZ", type: "article", publishedTime: "2026-04-16T08:00:00Z", modifiedTime: "2026-04-16T08:00:00Z", authors: ["DomovniGuru"], images: [{ url: "/api/og?title=Jak%20postavit%20vyv%C3%BD%C5%A1en%C3%BD%20z%C3%A1hon%20%E2%80%93%20d%C5%99ev%C4%9Bn%C3%BD%20nebo%20z%20betonu%202026&cat=blog", width: 1200, height: 630, alt: "Jak postavit vyvýšený záhon – dřevěný nebo z betonu 2026" }] },
