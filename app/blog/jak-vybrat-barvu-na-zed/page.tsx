          ...
          <article className="article-body">
            ...
            <div className="hero-illustration" aria-hidden="true">
              <svg viewBox="0 0 900 210" fill="none" xmlns="http://www.w3.org/2000/svg" className="hero-svg">
                ...
                {[
                  ...
                  <g key={i} transform={`translate(${30 + i * 68}, 20)`}>
                    ...
                    <rect x="0" y="55" width="56" height="25" rx="0" fill={dark}/>
                ...
                <g transform="translate(80, 130)">
                  ...
                  {[{cx:25,cy:22,r:10,fill:"#e8a0a0"},{cx:50,cy:15,r:9,fill:"#a0c0e8"},{cx:75,cy:18,r:10,fill:"#a0d0a0"},{cx:95,cy:28,r:8,fill:"#f0c080"},{cx:40,cy:38,r:8,fill:"#c0a0d8"},{cx:65,cy:40,r:9,fill:"#f0e080"}].map((c,i)=>(
              ...
              <div style={{display:"flex",justifyContent:"space-around",padding:"8px 30px 12px",fontSize:"9px",letterSpacing:"0.1em",color:"#a09080",textTransform:"uppercase",background:"#fdf8f4"}}>
                <span>🎨 Vzorník barevných odstínů</span><span>🖌️ Tah štětcem na zdi</span><span>📋 RAL kódování barev</span>
              </div>
            </div>
            ...
            <section id="psychologie">
              ...
              <div className="article-table-wrap">
                <table className="article-table">
                  <thead><tr><th>Barva</th><th>Psychologický efekt</th><th>Nejlepší místnost</th><th>Pozor na</th></tr></thead>
                  <tbody>
                    <tr><td><strong>🔴 Červená</strong></td><td>Zvyšuje tepovou frekvenci, stimuluje chuť k jídlu, dodává energii</td><td>Jídelna, obývák (akcent)</td><td>V ložnici způsobuje neklid a problémy se spánkem</td></tr>
                    <tr><td><strong>🟠 Oranžová</strong></td><td>Podporuje sociální interakci, navozuje teplo a pohodu</td><td>Obývák, herna, jídelna</td><td>Přesycené tóny mohou být agresivní</td></tr>
                    <tr><td><strong>🟡 Žlutá</strong></td><td>Zlepšuje náladu, stimuluje kreativitu, navozuje optimismus</td><td>Kuchyně, pracovna, chodba</td><td>Intenzivní žlutá způsobuje úzkost – volit světlejší odstíny</td></tr>
                    <tr><td><strong>🟢 Zelená</strong></td><td>Uklidňuje, snižuje stres, navozuje rovnováhu a přírodu</td><td>Ložnice, pracovna, koupelna</td><td>Příliš tmavá zelená může působit depresivně</td></tr>
                    <tr><td><strong>🔵 Modrá</strong></td><td>Snižuje krevní tlak, navozuje klid, podporuje soustředění</td><td>Ložnice, pracovna, koupelna</td><td>Studené modré bez teplého doplnění působí chladně</td></tr>
                    <tr><td><strong>🟣 Fialová</strong></td><td>Podporuje kreativitu a introspekci, působí luxusně</td><td>Ložnice, pracovna</td><td>Tmavá fialová místnost vizuálně zmenšuje</td></tr>
                    <tr><td><strong>⬜ Bílá</strong></td><td>Čistota, prostor, neutralita – nechá vyniknout nábytek</td><td>Kdekoliv</td><td>Čistá bílá může působit sterilně – volit teplou bílou (RAL 9010)</td></tr>
                    <tr><td><strong>▪️ Šedá</strong></td><td>Sofistikovanost, klid, neutralita – moderní základ</td><td>Obývák, ložnice, pracovna</td><td>Špatný odstín šedé působí smutně – volit teplé šedé s béžovým podtónem</td></tr>
                  </tbody>
                </table>
              </div>
            </section>
            ...
            <section id="barvy-mistnosti">
              ...
              <div className="article-table-wrap">
                <table className="article-table">
                  <thead><tr><th>Místnost</th><th>Doporučené barvy</th><th>Omyvatelnost</th><th>Paropropustnost</th><th>Typ pojivu</th></tr></thead>
                  <tbody>
                    <tr><td><strong>Kuchyně</strong></td><td>Žlutá, béžová, světlá zelená, bílá</td><td>🔴 Nutná – třída 1</td><td>Střední</td><td>Akrylátová nebo latexová omyvatelná</td></tr>
                    <tr><td><strong>Koupelna</strong></td><td>Světlá modrá, šedá, bílá, pastelová zelená</td><td>🔴 Nutná – třída 1</td><td>Vysoká (anti-plíseň)</td><td>Koupelnová barva s fungicidní přísadou</td></tr>
                    <tr><td><strong>Ložnice</strong></td><td>Tlumená modrá, šedozelená, teplá béžová, levandule</td><td>⭐⭐ Střední – třída 2</td><td>Vysoká</td><td>Minerální nebo prodyšná latexová</td></tr>
                    <tr><td><strong>Obývák</strong></td><td>Teplá bílá, šedá, terrakota, šalvějová zelená</td><td>⭐⭐ Střední – třída 2</td><td>Střední</td><td>Latexová nebo akrylátová</td></tr>
                    <tr><td><strong>Dětský pokoj</strong></td><td>Pastelové tóny, světlá žlutá, mint, levandule</td><td>🔴 Nutná – třída 1</td><td>Vysoká</td><td>Barva bez VOC emisí, certifikát A+</td></tr>
                    <tr><td><strong>Pracovna</strong></td><td>Světlá modrá, šedozelená, teplá bílá</td><td>⭐ Nízká – třída 3</td><td>Střední</td><td>Jakákoliv standardní</td></tr>
                    <tr><td><strong>Chodba</strong></td><td>Světlá neutrální (zvětší prostor), teplé tóny</td><td>🔴 Nutná – třída 1</td><td>Střední</td><td>Omyvatelná latexová nebo akrylátová</td></tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="testovani">
              ...
              <ul>
                ...
                <li><strong>✅ Sleduj vzorek v různých denních dobách:</strong> Ráno v přirozeném světle, v poledne, odpoledne a večer při umělém osvětlení. Barva se může měnit dramaticky — zvláště šedé a modré tóny.</li>
                <li><strong>✅ Testuj na správném podkladu:</strong> Vzorek vždy nanes na stejný podklad jaký bude ve výsledku.</li>
                <li><strong>✅ Porovnej s nábytkem a podlahou:</strong> Přilep vzorek vedle nábytku, dveří a podlahy která zůstane. Barva musí fungovat s celým prostorem — ne jen sama o sobě.</li>
              </ul>
            ...
            <section id="ral-ncs">
              ...
              <ul>
                ...
                <li><strong>NCS systém:</strong> Skandinávský systém, populární u designérů. Popisuje barvu na základě čtyř základních barev a přimíchání bílé a černé. Kód jako NCS S 2030-B90G ti přesně říká o jakou barvu jde.</li>
            ...
            <section id="faq">
              ...
              <div className="faq-list">
                <details className="faq-item">
                  <summary className="faq-summary">Bílá nebo barevná zeď – co je lepší volba?<span className="faq-icon">▾</span></summary>
                ...
                <details className="faq-item">
                  <summary className="faq-summary">Mohu míchat barvy různých výrobců?<span className="faq-icon">▾</span></summary>
                  <div className="faq-body">Technicky ano, ale nedoporučujeme to. Barvy různých výrobců mohou mít různá pojiva (akrylát vs. latex) a různé konzistence — výsledná barva bude nepředvídatelná a může se špatně nanášet nebo mít nestandardní odstín. Pokud potřebuješ smíchat dva odstíny, drž se jednoho výrobce a jedné řady produktů.</div>
                </details>
                <details className="faq-item">
                  <summary className="faq-summary">Jak poznat že barva je dostatečně omyvatelná?<span className="faq-icon">▾</span></summary>
                  <div className="faq-body">Na etiketě hledej „třídu omyvatelnosti" dle normy EN 13300. Třída 1 = odolná vůči mokrému otírání — vhodná do kuchyně, koupelny, chodby. Třída 2 = odolná vůči lehkému čištění. Třída 3 a výše = standardní, pouze do nenáročných prostor.</div>
                </details>
                <details className="faq-item">
                  <summary className="faq-summary">Jak vybrat barvu do malé místnosti?<span className="faq-icon">▾</span></summary>
                  <div className="faq-body">Pro optické zvětšení malé místnosti fungují světlé tóny — teplá bílá, světlá béžová nebo světlé pastelové barvy. Namaluj strop stejnou barvou jako stěny nebo ještě světlejším odstínem — místnost bude vypadat vyšší. Vyhni se tmavým barvám na všech stěnách. Jedna tmavá akcentní stěna ale může fungovat i v malé místnosti — dá jí hloubku.</div>
                </details>
                <details className="faq-item">
                  <summary className="faq-summary">Co jsou VOC emise a proč na nich záleží?<span className="faq-icon">▾</span></summary>
                  <div className="faq-body">VOC (Volatile Organic Compounds) jsou těkavé organické sloučeniny které se uvolňují z barvy při schnutí a ještě několik týdnů po nanesení. Způsobují bolesti hlavy, podráždění očí a dýchacích cest. Pro dětské pokoje, ložnice a alergiky hledej barvy s označením „nízký obsah VOC" nebo „bez VOC" a certifikát kvality ovzduší A nebo A+.</div>
                </details>
              </div>
            </section>
