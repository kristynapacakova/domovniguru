...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Jak malovat radiátor – příprava, barva a postup 2026", description: "Žloutoucí radiátor? Jak připravit povrch, vybrat teplotně odolnou barvu a malovat bez šmouh.", url: "https://www.domovniguru.cz/blog/jak-malovat-radiator", siteName: "DomovniGuru", locale: "cs_CZ", type: "article", publishedTime: "2026-04-13T08:00:00Z", modifiedTime: "2026-04-13T08:00:00Z", authors: ["DomovniGuru"], images: [{ url: "/api/og?title=Jak%20malovat%20radi%C3%A1tor%20%E2%80%93%20p%C5%99%C3%ADprava%2C%20spr%C3%A1vn%C3%A1%20barva%20a%20postup%202026&cat=blog", width: 1200, height: 630, alt: "Jak malovat radiátor – příprava, správná barva a postup 2026" }] },
