...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Jak ušetřit na vytápění bez výměny kotle 2026", description: "10 tipů jak snížit účty za topení o 20–30 % bez drahých investic.", url: "https://www.domovniguru.cz/blog/usetrit-na-vytapeni", siteName: "DomovniGuru", locale: "cs_CZ", type: "article", publishedTime: "2026-04-13T08:00:00Z", modifiedTime: "2026-04-13T08:00:00Z", authors: ["DomovniGuru"], images: [{ url: "/api/og?title=Jak%20u%C5%A1et%C5%99it%20na%20vyt%C3%A1p%C4%9Bn%C3%AD%20bez%20v%C3%BDm%C4%9Bny%20kotle%20%E2%80%93%2010%20tip%C5%AF%202026&cat=blog", width: 1200, height: 630, alt: "Jak ušetřit na vytápění bez výměny kotle – 10 tipů 2026" }] },
