...
const ARTICLES_BY_CAT: Record<string, Article[]> = {
  malovani: [
    ...
    { id: 6,  cat: "malovani", title: "Jakou barvu zvolit do vlhkých prostor?",                desc: "Koupelna, kuchyň, sklep – odolnost vůči vlhkosti.",                 slug: "barva-do-vlhkych-prostor",           read: "4 min" },
